...
# ==============================================================================
# BETEL (Chib, Shin and Simoni, 2018)
fout_bt <- betel_quantile(x, p = p, psi0 = 90, 
                          prior_mean = prior_mean, prior_sd = prior_sd, 
                          burn = burn, n_samples = n_samples, seed = 0953)
(qhat_bt <- mcmc_summary(fout_bt))
...
# ==============================================================================
# BETEL (Chib, Shin and Simoni, 2018)
psi0_vec <- seq(10, 120, by = 1)   

for (psi0 in psi0_vec) {
  
  cat("Trying psi0 =", psi0, "\n")
  
  res <- tryCatch({
    
    fout_bt <- betel_quantile(
      x,
      p = p,
      psi0 = psi0,
